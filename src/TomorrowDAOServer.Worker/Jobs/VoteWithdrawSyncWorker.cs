...
public class VoteWithdrawSyncWorker : TomorrowDAOServerWorkBase
{
    protected override WorkerBusinessType BusinessType => WorkerBusinessType.VoteWithdrawSync;

    public VoteWithdrawSyncWorker(ILogger<ScheduleSyncDataContext> logger,
