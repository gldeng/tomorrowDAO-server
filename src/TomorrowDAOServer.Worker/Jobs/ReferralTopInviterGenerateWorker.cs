...
public class ReferralTopInviterGenerateWorker : TomorrowDAOServerWorkBase
{
    protected override WorkerBusinessType BusinessType => WorkerBusinessType.TopInviterGenerate;
    
    public ReferralTopInviterGenerateWorker(ILogger<ScheduleSyncDataContext> logger, AbpAsyncTimer timer, 
