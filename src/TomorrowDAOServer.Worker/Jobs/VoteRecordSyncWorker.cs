...
public class VoteRecordSyncWorker : TomorrowDAOServerWorkBase
{
    protected override WorkerBusinessType BusinessType => WorkerBusinessType.VoteRecordSync;

    public VoteRecordSyncWorker(ILogger<ScheduleSyncDataContext> logger,
