...
public class ReferralSyncWorker : TomorrowDAOServerWorkBase
{
    protected override WorkerBusinessType BusinessType => WorkerBusinessType.ReferralSync;

    public ReferralSyncWorker(ILogger<ScheduleSyncDataContext> logger,
